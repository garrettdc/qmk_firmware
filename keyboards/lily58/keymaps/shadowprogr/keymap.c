...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* |--------+--------+--------+--------+--------+--------|--------.       ,--------|--------+--------+--------+--------+--------+--------| */
        _______, _______, _______, _______, _______, _______, RESCUE,          _______, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______, \
    /* `----------------------------------------------------/--------/         \--------\----------------------------------------------------' */
    ...
    /* |--------+--------+--------+--------+--------+--------|                         |--------+--------+--------+--------+--------+--------| */
        _______, _______, KC_INS,  KC_HOME, KC_PGUP, _______,                           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
    /* |--------+--------+--------+--------+--------+--------|--------.       ,--------|--------+--------+--------+--------+--------+--------| */
        _______, _______, KC_DEL,  KC_END,  KC_PGDN, _______, _______,         RESCUE,  _______, _______, _______, _______, _______, _______, \
    /* `----------------------------------------------------/--------/         \--------\----------------------------------------------------' */
    ...
    [_ADJUST] = LAYOUT( \
    /* ,-----------------------------------------------------.                         ,-----------------------------------------------------. */
        XXXXXXX, QWERTY,  DVORAK,  COLEMAK, XXXXXXX, XXXXXXX,                           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    /* |--------+--------+--------+--------+--------+--------|                         |--------+--------+--------+--------+--------+--------| */
        EEP_RST, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                           XXXXXXX, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, \
    /* |--------+--------+--------+--------+--------+--------|                         |--------+--------+--------+--------+--------+--------| */
        RESET,   XXXXXXX, KC_VOLU, KC_MNXT, KC_MPLY, XXXXXXX,                           XXXXXXX, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, \
    /* |--------+--------+--------+--------+--------+--------|--------.       ,--------|--------+--------+--------+--------+--------+--------| */
        XXXXXXX, XXXXXXX, KC_VOLD, KC_MPRV, KC_MUTE, XXXXXXX, XXXXXXX,         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    /* `----------------------------------------------------/--------/         \--------\----------------------------------------------------' */
