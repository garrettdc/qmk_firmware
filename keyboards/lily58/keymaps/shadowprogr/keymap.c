...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* `----------------------------------------------------/--------/         \--------\----------------------------------------------------' */
                              XXXXXXX, XXXXXXX, XXXXXXX,    KC_ENT,              KC_ENT,       KC_BSPC, XXXXXXX, NUMPAD                       \
    /*                       `-------------------------'  '--------'             '---------'  `-------------------------'                      */
    ),
    ...
    /* |--------+--------+--------+--------+--------+--------|--------.       ,--------|--------+--------+--------+--------+--------+--------| */
        _______, _______, _______, _______, _______, _______, RESCUE,          _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_CAPS, \
    /* `----------------------------------------------------/--------/         \--------\----------------------------------------------------' */
    ...
    /* |--------+--------+--------+--------+--------+--------|--------.       ,--------|--------+--------+--------+--------+--------+--------| */
        KC_CAPS, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,         RESCUE,  _______, _______, _______, _______, _______, KC_CAPS, \
    /* `----------------------------------------------------/--------/         \--------\----------------------------------------------------' */
