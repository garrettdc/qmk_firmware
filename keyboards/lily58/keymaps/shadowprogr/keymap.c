...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_LOWER] = LAYOUT( \
        ...
        RESET,   RGB_VAI, _______, _______, _______, _______,                           KC_UNDS, KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, _______, \
        KC_CAPS, RGB_VAD, _______, _______, _______, _______, _______,         _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_CAPS, \
...
void rgb_matrix_indicators_user(void) {
    ...
    led_state.caps_lock ? rgb_matrix_set_color(24, 0, 255, 0) : rgb_matrix_set_color(24, 255, 0, 0);
    if (isLeftHand) {

    } else {
        led_state.num_lock ? rgb_matrix_set_color(6, 0, 255, 0) : rgb_matrix_set_color(6, 255, 0, 0);
    }
}
