...
#define LAYOUT_lily58_base( \
  ...
  LAYOUT_wrapper( \
    ...
    MT_CT_E, K11,     K12,     K13,     K14,     K15,                               K16,     K17,     K18,     K19,     K1A,     K1B,     \
    KC_LSFT, K21,     K22,     K23,     K24,     K25,     KC_MINS,         KC_EQL,  K26,     K27,     K28,     K29,     K2A,     KC_RSFT, \
                               KC_LALT, KC_LGUI, KC_SPC,  LT_LWR,          LT_RSE,  KC_BSPC, KC_RGUI, KC_LEAD                             \
  )
// clang-format on
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_lily58_base_wrapper( \
        ...
        _________________QWERTY_L2_________________, _________________QWERTY_R2_________________, MT_CT_Q, \
        _________________QWERTY_L3_________________, _________________QWERTY_R3_________________           \
    ),

    [_DVORAK] = LAYOUT_lily58_base_wrapper( \
        _________________DVORAK_L1_________________, _________________DVORAK_R1_________________,          \
        _________________DVORAK_L2_________________, _________________DVORAK_R2_________________, MT_CT_S, \
    ...
    [_COLEMAK] = LAYOUT_lily58_base_wrapper( \
        ...
        ________________COLEMAK_DH_L2______________, ________________COLEMAK_DH_R2______________, MT_CT_Q, \
    ...
    [_LOWER] = LAYOUT_wrapper( \
        ...
        _______, _________________LOWER_L3__________________, TG_RESC,         _______, _________________LOWER_R3__________________, _______, \
    ...
    [_RAISE] = LAYOUT_wrapper( \
        ...
        _______, _________________RAISE_L3__________________, _______,         TG_RESC, _________________RAISE_R3__________________, _______, \
    ...
    [_RESCUE] = LAYOUT_wrapper( \
        ...
        _____________________DISABLED_______________________, TG_RESC,         TG_RESC, _____________________DISABLED_______________________, \
